...
export default function KickoffMode({ onComplete, screenScale = 1, kickoffConfig = {} }) {
        ...
        {phase === 'countdown' ? (
          <>
            <motion.h1 
              ...
              style={{ fontSize: `${90 * s}px`, marginBottom: `${24 * s}px` }}
            ...
            <motion.p 
              ...
              style={{ fontSize: `${52 * s}px`, marginBottom: `${48 * s}px` }}
              initial={{ y: 20, opacity: 0 }}
